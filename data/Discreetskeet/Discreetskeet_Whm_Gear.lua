...
function init_gear_sets()
    ...
    sets.precast.FC = {"Sucellus",sub="Genbu's Shield",ammo="Pemphredo Tathlum",
		head="Vanya Hood",neck="Loricate Torque",ear1="Etiolation Earring",ear2="Loquac. Earring",
		body="Inyanga Jubbah +1",hands="Kaykaus Cuffs",ring1="Kishar Ring",ring2="Lebeche Ring",
		back="Alaunus's Cape",waist="Witful Belt",legs="Kaykaus Tights",feet="Hygieia Clogs"}
		
    sets.precast.FC.DT = {"Sucellus",sub="Genbu's Shield",ammo="Pemphredo Tathlum",
		head="Vanya Hood",neck="Loricate Torque",ear1="Etiolation Earring",ear2="Loquac. Earring",
		body="Inyanga Jubbah +1",hands="Kaykaus Cuffs",ring1="Kishar Ring",ring2="Lebeche Ring",
		back="Alaunus's Cape",waist="Witful Belt",legs="Kaykaus Tights",feet="Hygieia Clogs"}
	...
	sets.precast.FC.Cure.DT = {"Sucellus",sub="Genbu's Shield",ammo="Pemphredo Tathlum",
		head="Vanya Hood",neck="Loricate Torque",ear1="Etiolation Earring",ear2="Loquac. Earring",
		body="Inyanga Jubbah +1",hands="Kaykaus Cuffs",ring1="Kishar Ring",ring2="Lebeche Ring",
		back="Alaunus's Cape",waist="Witful Belt",legs="Kaykaus Tights",feet="Hygieia Clogs"}
	...
	sets.midcast.Cursna = {main=gear.grioavolr_fc_staff,sub="Clemency Grip",ammo="Hasty Pinion +1",
		head="Ebers Cap +1",neck="Mallison Medallion",ear1="Enchntr. Earring +1",ear2="Loquacious Earring",
	...
	sets.midcast.Stun.Resistant = {main="Oranyan",sub="Enki Strap",ammo="Pemphredo Tathlum",
		head="Vanya Hood",neck="Erra Pendant",ear1="Regal Earring",ear2="Digni. Earring",
		body="Inyanga Jubbah +1",hands="Fanatic Gloves",ring1="Stikini Ring",ring2="Stikini Ring",
		back="Aurist's Cape +1",waist="Acuity Belt +1",legs="Chironic Hose",feet=gear.chironic_nuke_feet}
	...
	sets.defense.PDT = {main="Bolelabunga",sub="Genmei Shield",ammo="Staunch Tathlum",
		head="Gende. Caubeen +1",neck="Loricate Torque",ear1="Etiolation Earring",ear2="Ethereal Earring",
	...
	sets.defense.MDT = {main="Mafic Cudgel",sub="Genmei Shield",ammo="Staunch Tathlum",
		head="Gende. Caubeen +1",neck="Loricate Torque",ear1="Etiolation Earring",ear2="Sanare Earring",
