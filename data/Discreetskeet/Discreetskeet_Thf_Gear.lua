...
function init_gear_sets()
	...
	-- Weapons sets
	sets.weapons.Aeneas = {main="Skinflayer",sub="Sandung"}
	sets.weapons.LowBuff = {main="Skinflayer",sub="Sandung"}
	sets.weapons.MagicWeapons = {main="Skinflayer",sub="Sandung"}
	sets.weapons.Throwing = {main="Skinflayer",sub="Sandung",range="Comet Tail",ammo=empty}
    ...
    sets.precast.Step = {ammo="Falcon Eye",
        ...
        back=DA_DEX_THF_back,waist="Olseni Belt",legs="Mummu Kecks +2",feet=gear.herculean_acc_feet}
    ...
    sets.precast.WS = {ammo="Falcon Eye",
        ...
        back=DA_DEX_THF_back,waist="Grunfeld Rope",legs="Samnuha Tights",feet=gear.herculean_wsd_feet}
    ...
    sets.precast.WS["Rudra's Storm"] = set_combine(sets.precast.WS, {head="Lilitu Headpiece",neck="Caro Necklace",ear1="Moonshade Earring",ear2="Ishvara Earring",body="Adhemar Jacket +1",back=WSD_DEX_THF_back})
    sets.precast.WS["Rudra's Storm"].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {head="Lilitu Headpiece",neck="Caro Necklace",ear1="Moonshade Earring",body="Meg. Cuirie +2",back=WSD_DEX_THF_back})
    sets.precast.WS["Rudra's Storm"].Acc = set_combine(sets.precast.WS.Acc, {ear1="Moonshade Earring",body="Meg. Cuirie +2",back=WSD_DEX_THF_back})
	sets.precast.WS["Rudra's Storm"].FullAcc = set_combine(sets.precast.WS.FullAcc, {back=WSD_DEX_THF_back})
    ...
    sets.precast.WS["Mandalic Stab"] = set_combine(sets.precast.WS, {head="Lilitu Headpiece",neck="Caro Necklace",ear1="Moonshade Earring",ear2="Ishvara Earring",body="Meg. Cuirie +2",back=WSD_DEX_THF_back})
    sets.precast.WS["Mandalic Stab"].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {head="Lilitu Headpiece",neck="Caro Necklace",ear1="Moonshade Earring",body="Meg. Cuirie +2",back=WSD_DEX_THF_back})
    sets.precast.WS["Mandalic Stab"].Acc = set_combine(sets.precast.WS.Acc, {ear1="Moonshade Earring",body="Meg. Cuirie +2",back=WSD_DEX_THF_back})
	sets.precast.WS["Mandalic Stab"].FullAcc = set_combine(sets.precast.WS.FullAcc, {back=WSD_DEX_THF_back})
    ...
    sets.precast.WS["Shark Bite"] = set_combine(sets.precast.WS, {head="Lilitu Headpiece",neck="Caro Necklace",ear1="Moonshade Earring",ear2="Ishvara Earring",body="Meg. Cuirie +2",back=WSD_DEX_THF_back})
    sets.precast.WS["Shark Bite"].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {head="Lilitu Headpiece",neck="Caro Necklace",ear1="Moonshade Earring",body="Meg. Cuirie +2",back=WSD_DEX_THF_back})
    sets.precast.WS["Shark Bite"].Acc = set_combine(sets.precast.WS.Acc, {ear1="Moonshade Earring",body="Meg. Cuirie +2",back=WSD_DEX_THF_back})
	sets.precast.WS["Shark Bite"].FullAcc = set_combine(sets.precast.WS.FullAcc, {back=WSD_DEX_THF_back})
    ...
    sets.precast.WS['Evisceration'] = {
		...
		back=CRIT_DEX_THF_back,
	}
    sets.precast.WS['Evisceration'].SomeAcc = set_combine(sets.precast.WS['Evisceration'], {head="Adhemar Bonnet +1",neck="Fotia Gorget",body="Abnoba Kaftan",hands="Mummu Wrists +2",ring1="Begrudging Ring",waist="Fotia Belt",legs="Mummu Kecks +2",feet="Mummu Gamash. +2"})
    sets.precast.WS['Evisceration'].Acc = set_combine(sets.precast.WS['Evisceration'], {head="Mummu Bonnet +2",ring1="Begrudging Ring",neck="Fotia Gorget",body="Sayadio's Kaftan",hands="Mummu Wrists +2",waist="Fotia Belt",legs="Mummu Kecks +2",feet="Mummu Gamash. +2"})
    ...
    sets.precast.WS['Last Stand'] = {
        ...
        back=WSD_DEX_THF_back,waist="Fotia Belt",legs="Mummu Kecks +2",feet="Mummu Gamash. +2"}
    ...
    sets.precast.WS['Aeolian Edge'] = {ammo="Seeth. Bomblet +1",
        ...
        back=WSD_DEX_THF_back,waist="Chaac Belt",legs=gear.herculean_wsd_legs,feet=gear.herculean_nuke_feet}
    ...
    sets.midcast.RA = {
        ...
        body="Mummu Jacket +2",hands="Mummu Wrists +2",ring1="Apate Ring",ring2="Regal Ring",
        back=DA_DEX_THF_back,waist="Chaac Belt",legs="Mummu Kecks +2",feet="Mummu Gamash. +2"}
    ...
    sets.engaged.SomeAcc = {ammo="Yamarang",
        ...
        back=DA_DEX_THF_back,waist="Reiki Yotai",legs="Samnuha Tights",feet=gear.herculean_ta_feet}
	...
	sets.engaged.Acc = {ammo="Yamarang",
        ...
        back=DA_DEX_THF_back,waist="Olseni Belt",legs="Meg. Chausses +2",feet=gear.herculean_acc_feet}
