...
function init_gear_sets()
	...
	sets.midcast.SongEffect = {main="Kali",sub="Genmei Shield",range="Gjallarhorn",ammo=empty,
		head="Fili Calot +1",neck="Moonbow Whistle +1",ear1="Enchntr. Earring +1",ear2="Loquacious Earring",
		body="Fili Hongreline +1",hands="Fili Manchettes +1",ring1="Stikini Ring",ring2="Stikini Ring",
	...
	sets.midcast['Shining Fantasia'] = {main="Taming Sari",range=info.ExtraSongInstrument,
		head="Nahtirah Hat",ear2="Loquacious Earring",
		body="Vanir Cotehardie",hands="Kaykaus Cuffs +1",ring1="Prolix Ring",
		back="Swith Cape",waist="Embla Sash",legs="Assiduity Pants +1",feet="Medium's Sabots"}
	
	sets.midcast['Goblin Gavotte'] = {main="Taming Sari",range=info.ExtraSongInstrument,
		head="Nahtirah Hat",ear2="Loquacious Earring",
		body="Vanir Cotehardie",hands="Kaykaus Cuffs +1",ring1="Prolix Ring",
		back="Swith Cape",waist="Embla Sash",legs="Assiduity Pants +1",feet="Medium's Sabots"}
	...
	sets.idle = {main="Kali",sub="Genbu's Shield",ammo="Staunch Tathlum",
		head="Inyanga Tiara +1",neck="Loricate Torque",ear1="Etiolation Earring",ear2="Darkside Earring",
		body="Inyanga Jubbah +1",hands="Inyanga Dastanas +1",ring1="Defending Ring",ring2="Inyanga Ring",
		back=MoonCape13,waist="Flume Belt",legs="Inyanga Shalwar +2",feet="Inyan. Crackows +2",}
