...
function init_gear_sets()
	...
	sets.precast.FC = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap +1",ammo="Impatiens",
		head="Vanya Hood",neck="Voltsurge Torque",ear1="Enchntr. Earring +1",ear2="Loquacious Earring",
		body="Mallquis Saio +2",hands="Mallquis Cuffs +2",ring1="Kishar Ring",ring2="Lebeche Ring",
		back="Lifestream Cape",waist="Witful Belt",legs="Geo. Pants +2",feet=gear.merlinic_refresh_feet}
	...
	sets.precast.FC.Impact = {ammo="Impatiens",
		...
		back="Lifestream Cape",waist="Witful Belt",legs="Geo. Pants +2",feet="Regal Pumps +1"}
	...
	sets.midcast.Geomancy = {main="Solstice",sub="Genbu's Shield",range="Dunna",
		head="Vanya Hood",neck="Bagua Charm +2",ear1="Etiolation Earring",ear2="Loquacious Earring",
		body="Bagua Tunic +3",hands="Geo. Mitaines +3",ring1="Stikini Ring",ring2="Defending Ring",
		back="Lifestream Cape",waist="Witful Belt",legs="Vanya Slops",feet=gear.merlinic_refresh_feet}


	--Extra Indi duration as long as you can keep your 900 skill cap.
	sets.midcast.Geomancy.Indi = set_combine(sets.midcast.Geomancy, {main="Solstice",back="Lifestream Cape",legs="Bagua Pants +1",feet="Azimuth Gaiters +1"})
		
    sets.midcast.Cure = {main="Gada",sub="Genbu's Shield",range="Dunna",
        head="Vanya Hood",neck="Deviant Necklace",ear1="Gifted Earring",ear2="Etiolation Earring",
        body="Mallquis Saio +2",hands="Telchine Gloves",ring1="Kishar Ring",ring2="Lebeche Ring",
        back="Tempered Cape +1",waist="Witful Belt",legs=gear.merlinic_refresh_legs,feet="Vanya Clogs"}
		
    sets.midcast.LightWeatherCure = {main="Gada",sub="Genbu's Shield",range="Dunna",
        head="Vanya Hood",neck="Deviant Necklace",ear1="Gifted Earring",ear2="Etiolation Earring",
        body="Mallquis Saio +2",hands="Telchine Gloves",ring1="Kishar Ring",ring2="Lebeche Ring",
        back="Tempered Cape +1",waist="Witful Belt",legs=gear.merlinic_refresh_legs,feet="Vanya Clogs"}
		
		--Cureset for if it's not light weather but is light day.
    sets.midcast.LightDayCure = {main="Gada",sub="Genbu's Shield",range="Dunna",
        head="Vanya Hood",neck="Deviant Necklace",ear1="Gifted Earring",ear2="Etiolation Earring",
        body="Mallquis Saio +2",hands="Telchine Gloves",ring1="Kishar Ring",ring2="Lebeche Ring",
        back="Tempered Cape +1",waist="Witful Belt",legs=gear.merlinic_refresh_legs,feet="Vanya Clogs"}
	...
	--legs={ name="Merlinic Shalwar", augments={'STR+10','Pet: INT+7','"Refresh"+2',}},
	...
	sets.idle = {main="Bolelabunga",sub="Genbu's Shield",ammo="Staunch Tathlum",
		head="Befouled Crown",neck="Loricate Torque",ear1="Genmei Earring",ear2="Ethereal Earring",
		body="Jhakri Robe +2",hands=gear.merlinic_refresh_hands,ring1="Dark Ring",ring2="Defending Ring",
		back=gear.idle_jse_back,waist="Flax Sash",legs=gear.merlinic_refresh_legs,feet=gear.merlinic_refresh_feet}
		
	sets.idle.PDT = {main="Terra's Staff",sub="Umbra Strap",ammo="Staunch Tathlum",
		head="Hagondes Hat +1",neck="Loricate Torque",ear1="Genmei Earring",ear2="Ethereal Earring",
		body="Jhakri Robe +2",hands="Hagondes Cuffs +1",ring1="Dark Ring",ring2="Defending Ring",
	...
	sets.idle.Pet = {main="Sucellus",sub="Genbu's Shield",range="Dunna",
		head="Befouled Crown",neck="Loricate Torque",ear1="Handler's Earring",ear2="Etiolation Earring",
		body="Mallquis Saio +2",hands=gear.merlinic_refresh_hands,ring1="Dark Ring",ring2="Defending Ring",
		back=gear.idle_jse_back,waist="Isa Belt",legs=gear.merlinic_refresh_legs,feet=gear.merlinic_refresh_feet}
	...
	sets.idle.Weak = {main="Bolelabunga",sub="Genbu's Shield",ammo="Staunch Tathlum",
		head="Befouled Crown",neck="Loricate Torque",ear1="Etiolation Earring",ear2="Ethereal Earring",
		body="Jhakri Robe +2",hands=gear.merlinic_refresh_hands,ring1="Dark Ring",ring2="Defending Ring",
	...
	sets.defense.PDT = {main="Terra's Staff",sub="Umbra Strap",ammo="Staunch Tathlum",
		head="Hagondes Hat +1",neck="Loricate Torque",ear1="Etiolation Earring",ear2="Handler's Earring +1",
	...
	sets.defense.MDT = {main="Terra's Staff",sub="Umbra Strap",ammo="Staunch Tathlum",
		head="Azimuth Hood +1",neck="Loricate Torque",ear1="Etiolation Earring",ear2="Handler's Earring +1",
		body="Mallquis Saio +2",hands="Hagondes Cuffs +1",ring1="Dark Ring",ring2="Defending Ring",
		back="Umbra Cape",waist="Flax Sash",legs="Hagondes Pants +1",feet="Azimuth Gaiters +1"}
