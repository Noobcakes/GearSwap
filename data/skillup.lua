...
user_settings = {
    user_spells = {
        Healing = T{},
        Geomancy = T{'Indi-Poison','Indi-Refresh'},
        Enhancing = T{'Protect','Shell','Phalanx','Enthunder','Enstone','Enaero','Enblizzard','Enfire','Enwater',},
        Ninjutsu = T{},
        Singing = T{'Advancing March','Victory March','Fire Carol','Ice Carol','Wind Carol','Earth Carol','Lightning Carol','Water Carol','Light Carol','Dark Carol'},
        Blue = T{},
        Summoning = T{'Ifrit','Shiva','Ramuh','Titan','Garuda','Leviathan'}},
